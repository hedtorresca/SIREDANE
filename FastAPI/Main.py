...
app = FastAPI(
    title="SIRE - Sistema de Identificación Estadística",
    description="API para generar IDs estadísticos para pseudonimización de datos",
    version="1.0.0"
)

@app.get("/")
def read_root():
    return {"message": "SIRE - Sistema de Identificación Estadística"}
